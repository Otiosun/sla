...
# Bootstrap verifies Gen I-III source provenance, then reconciles the playable world to Zhoulia before validation/publication/activation.
...
require_literal "$bootstrap_script" "reconcileZhouliaExclusiveRelease"
require_literal "$bootstrap_script" "assertZhouliaExclusiveRelease"
require_literal "$bootstrap_script" "loadCanonicalZhouliaStarterOptions"
require_literal "$bootstrap_script" "starterOptions: canonicalStarterOptions"
require_literal "$bootstrap_script" "refusing to infer it from Gen I-III source starters"
require_literal "$bootstrap_script" "validateRelease"
require_literal "$bootstrap_script" "publishRuleset"
require_literal "$bootstrap_script" "publishRelease"
reject_literal "$bootstrap_script" "publishGen123"
