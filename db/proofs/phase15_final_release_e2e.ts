...
if (world.status !== "DRAFT" || world.activeAreas < 3 || world.connections < 1)
...
if (secondWorld.status !== "PUBLISHED" || secondWorld.connections !== world.connections)
...
if (secondPublish.releaseStatus !== "PUBLISHED" || secondPublish.activeReleaseId !== published.activeReleaseId)
