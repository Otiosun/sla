  ...
  public async applyPokemonCreate(
    ...
    return this.completion.completeAppliedOperation({
      ...
      afterData: {
        ...
        formId: value.formId,
        level: value.level,
        nickname: value.nickname ?? input.nickname ?? null,
        shiny: value.shiny ?? input.shiny ?? false,
        gender: value.gender ?? input.gender ?? null,
        abilityId: value.abilityId ?? input.abilityId ?? null,
        natureId: value.natureId ?? input.natureId ?? null,
