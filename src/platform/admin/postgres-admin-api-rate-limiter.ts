...
const DEFAULT_POLICIES: Readonly<Record<AdminApiRateLimitedOperation, AdminApiRateLimitPolicy>> = {
  ...
  "content.analytics.read": { limit: 30, windowSeconds: 60 },
  ...
  public constructor(pool: Pool, overrides: AdminApiRateLimitPolicyOverrides = {}) {
    ...
    this.policies = {
      ...
      "content.analytics.read":
        overrides["content.analytics.read"] ?? DEFAULT_POLICIES["content.analytics.read"],
    ...
    validatePolicy("content.analytics.read", this.policies["content.analytics.read"]);
