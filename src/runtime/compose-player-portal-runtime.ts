...
import { PlayerPortalLocationReadService } from "../modules/player-portal/location-read-service.js";
...
export function composePlayerPortalRuntime(
  ...
  const location = new PlayerPortalLocationReadService(playerRepository, world);
  ...
  const portal = new PlayerPortalHttpHandler({ tickets, sessions, player, location, roster });
